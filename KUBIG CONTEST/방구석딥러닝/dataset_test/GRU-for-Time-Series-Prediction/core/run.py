...
def main(configs, data_filename, sentiment_type, flag_pred, model_name, num_csvs, folder_name):
    ...
    base_path = "dataset_test/GRU-for-Time-Series-Prediction"
    data = FNSPIDDataset(
        ...
        for i in range(3):
          ...
          for sentiment_type in sentiment_types:
            for name in names:
              ...
              config_path = f"/content/FNSPID/dataset_test/GRU-for-Time-Series-Prediction/{sentiment_type}_config.json"
